...
import { a as getAdapter, c as createInternalAdapter, e as getMigrations } from './better-auth.DiiCErDI.mjs';
import { g as getAuthTables } from './better-auth.DhziC0ap.mjs';
import 'zod';
import './better-auth.BZghgUMh.mjs';
import { g as getCookies, c as createCookieGetter } from './better-auth.L4mY8Wf-.mjs';
import { c as createLogger } from './better-auth.DgGir396.mjs';
import { U as socialProviders } from './better-auth.CpZXDeOc.mjs';
...
import { e as env, b as isProduction } from './better-auth.CiuwFiHM.mjs';
...
import { g as getKyselyDatabaseType } from './better-auth.BJYrr86k.mjs';
import { B as BASE_ERROR_CODES } from './better-auth.D_jpufHc.mjs';
...
const createTelemetry = async (...args) => {
  if (!lazyImportCreateTelemetry) {
    lazyImportCreateTelemetry = import('../chunks/create-telemetry.mjs').then(
...
export { betterAuth as b, createTelemetry as c };
